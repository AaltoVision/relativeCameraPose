...
function M.parse(arg)
    ...
    ------------- Data options ------------------------
    --cmd:option("-data_description_path", "/hdd/projects/image_retrieval/camera_pose_estimation/data/1dsfm" , "home directory for text data")
    ...
    cmd:option('-epochNumber', 8,     'Manual epoch number (useful on restarts)')
    cmd:option("-max_epoch",   10, "number of training epochs")
    cmd:option("-snapshot_dir", "/ssd_storage/projects/relative_camera_pose/snapshots/dtu/siam_hybridnet_spp_fullsized_from_hybridnet", "snapshot directory")
